...
const App = () => (
  <div className="tc-main-bg-container">
    <div className="tc-bg-container">
      <h1 className="tc-main-heading">Learn 4.O Technologies</h1>
      ...
      <ul className="cards-main-container">
